...
type PlaceholderPageProps = {
  ...
  description: string;
  icon: LucideIcon;
  /** What this view will do once the corresponding stage is implemented. */
  plannedFor: string[];
};
        ...
        <PanelBody className="flex flex-col items-center gap-5 py-10 text-center sm:py-14">
          ...
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-md text-sm leading-relaxed text-ink-muted">
              This section is not implemented yet. It is part of a later stage of the project and
              intentionally ships empty rather than as a fake screen.
            </p>
          </div>
