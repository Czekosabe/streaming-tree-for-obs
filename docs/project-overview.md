...
| 20C1 | macOS packaged runtime: unsigned `.app`/DMG, real lifecycle adapters, native macOS CI package verification (see [macos-packaging.md](macos-packaging.md)) | In progress |
