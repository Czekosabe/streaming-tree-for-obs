// Vendored from Google's official YouTube Live Streaming API documentation:
// https://developers.google.com/youtube/v3/live/streaming-live-chat
// (the "stream_list.proto" code sample on that page), re-verified against
// the live page on 2026-08-12 as part of the Stage 15A transport corrective
// pass (docs/provider-integrations/youtube-engagement.md). Copied verbatim
// except for one addition: the `import "google/protobuf/duration.proto";`
// line below, which the published code sample omits (LiveChatGiftDetails
// references google.protobuf.Duration by name without importing it - almost
// certainly elided for brevity in the docs, not a real difference in
// Google's own build) but protoc requires to resolve LiveChatGiftDetails.
// gift_duration. A `go_package` option was also added, since one is
// required to generate Go code and the docs page's sample - written for
// Python - does not include one; no other content was changed.
//
// Google's developer documentation content, including code samples such as
// this one, is licensed under the Apache License, Version 2.0:
// https://developers.google.com/site-policies#license
//
// See apps/server/internal/provider/youtube/streamlistpb/README.md for the
// maintainer regeneration procedure.
...
func (LiveChatUserBannedMessageDetails_BanTypeWrapper_BanType) EnumDescriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{6, 0, 0}
}
...
func (LiveChatPollDetails_PollStatusWrapper_PollStatus) EnumDescriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{14, 1, 0}
}
...
func (*LiveChatUserBannedMessageDetails_BanTypeWrapper) Descriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*LiveChatPollDetails_PollMetadata) Descriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{14, 0}
}
...
func (*LiveChatPollDetails_PollStatusWrapper) Descriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{14, 1}
}
...
func (*LiveChatPollDetails_PollMetadata_PollOption) Descriptor() ([]byte, []int) {
	return file_stream_list_proto_rawDescGZIP(), []int{14, 0, 0}
}
...
const file_stream_list_proto_rawDesc = "" +
	...
	"\x11is_chat_moderator\x18\a \x01(\bR\x0fisChatModerator\"\xcd\r\n" +
	...
	"\x14text_message_details\x18\x13 \x01(\v2*.youtube.api.v3.LiveChatTextMessageDetailsH\x00R\x12textMessageDetails\x12b\n" +
	...
	"\fgift_details\x18\" \x01(\v2#.youtube.api.v3.LiveChatGiftDetailsH\x00R\vgiftDetails\x1a\xa4\x03\n" +
	"\vTypeWrapper\"\x94\x03\n" +
	"\x04Type\x12\x10\n" +
	...
	"\fmessage_text\x18\x01 \x01(\tR\vmessageText\"\xca\x02\n" +
	...
	"\n" +
	"StreamList\x12*.youtube.api.v3.LiveChatMessageListRequest\x1a+.youtube.api.v3.LiveChatMessageListResponse\"\x000\x01BIZGgithub.com/streaming-tree/server/internal/provider/youtube/streamlistpb"
...
var file_stream_list_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_stream_list_proto_goTypes = []any{
	...
	(*LiveChatUserBannedMessageDetails)(nil),                     // 9: youtube.api.v3.LiveChatUserBannedMessageDetails
	(*LiveChatSuperChatDetails)(nil),                             // 10: youtube.api.v3.LiveChatSuperChatDetails
	(*LiveChatSuperStickerDetails)(nil),                          // 11: youtube.api.v3.LiveChatSuperStickerDetails
	(*LiveChatFanFundingEventDetails)(nil),                       // 12: youtube.api.v3.LiveChatFanFundingEventDetails
	(*LiveChatNewSponsorDetails)(nil),                            // 13: youtube.api.v3.LiveChatNewSponsorDetails
	(*LiveChatMemberMilestoneChatDetails)(nil),                   // 14: youtube.api.v3.LiveChatMemberMilestoneChatDetails
	(*LiveChatMembershipGiftingDetails)(nil),                     // 15: youtube.api.v3.LiveChatMembershipGiftingDetails
	(*LiveChatGiftMembershipReceivedDetails)(nil),                // 16: youtube.api.v3.LiveChatGiftMembershipReceivedDetails
	(*LiveChatPollDetails)(nil),                                  // 17: youtube.api.v3.LiveChatPollDetails
	(*LiveChatGiftDetails)(nil),                                  // 18: youtube.api.v3.LiveChatGiftDetails
	(*SuperChatEventSnippet)(nil),                                // 19: youtube.api.v3.SuperChatEventSnippet
	(*SuperStickerMetadata)(nil),                                 // 20: youtube.api.v3.SuperStickerMetadata
	(*ChannelProfileDetails)(nil),                                // 21: youtube.api.v3.ChannelProfileDetails
	(*PageInfo)(nil),                                             // 22: youtube.api.v3.PageInfo
	(*LiveChatMessageSnippet_TypeWrapper)(nil),                   // 23: youtube.api.v3.LiveChatMessageSnippet.TypeWrapper
	(*LiveChatUserBannedMessageDetails_BanTypeWrapper)(nil),      // 24: youtube.api.v3.LiveChatUserBannedMessageDetails.BanTypeWrapper
	(*LiveChatPollDetails_PollMetadata)(nil),                     // 25: youtube.api.v3.LiveChatPollDetails.PollMetadata
	(*LiveChatPollDetails_PollStatusWrapper)(nil),                // 26: youtube.api.v3.LiveChatPollDetails.PollStatusWrapper
	(*LiveChatPollDetails_PollMetadata_PollOption)(nil),          // 27: youtube.api.v3.LiveChatPollDetails.PollMetadata.PollOption
	(*durationpb.Duration)(nil),                                  // 28: google.protobuf.Duration
}
var file_stream_list_proto_depIdxs = []int32{
	22, // 0: youtube.api.v3.LiveChatMessageListResponse.page_info:type_name -> youtube.api.v3.PageInfo
	...
	9,  // 7: youtube.api.v3.LiveChatMessageSnippet.user_banned_details:type_name -> youtube.api.v3.LiveChatUserBannedMessageDetails
	10, // 8: youtube.api.v3.LiveChatMessageSnippet.super_chat_details:type_name -> youtube.api.v3.LiveChatSuperChatDetails
	11, // 9: youtube.api.v3.LiveChatMessageSnippet.super_sticker_details:type_name -> youtube.api.v3.LiveChatSuperStickerDetails
	13, // 10: youtube.api.v3.LiveChatMessageSnippet.new_sponsor_details:type_name -> youtube.api.v3.LiveChatNewSponsorDetails
	14, // 11: youtube.api.v3.LiveChatMessageSnippet.member_milestone_chat_details:type_name -> youtube.api.v3.LiveChatMemberMilestoneChatDetails
	15, // 12: youtube.api.v3.LiveChatMessageSnippet.membership_gifting_details:type_name -> youtube.api.v3.LiveChatMembershipGiftingDetails
	16, // 13: youtube.api.v3.LiveChatMessageSnippet.gift_membership_received_details:type_name -> youtube.api.v3.LiveChatGiftMembershipReceivedDetails
	17, // 14: youtube.api.v3.LiveChatMessageSnippet.poll_details:type_name -> youtube.api.v3.LiveChatPollDetails
	18, // 15: youtube.api.v3.LiveChatMessageSnippet.gift_details:type_name -> youtube.api.v3.LiveChatGiftDetails
	21, // 16: youtube.api.v3.LiveChatUserBannedMessageDetails.banned_user_details:type_name -> youtube.api.v3.ChannelProfileDetails
	1,  // 17: youtube.api.v3.LiveChatUserBannedMessageDetails.ban_type:type_name -> youtube.api.v3.LiveChatUserBannedMessageDetails.BanTypeWrapper.BanType
	20, // 18: youtube.api.v3.LiveChatSuperStickerDetails.super_sticker_metadata:type_name -> youtube.api.v3.SuperStickerMetadata
	25, // 19: youtube.api.v3.LiveChatPollDetails.metadata:type_name -> youtube.api.v3.LiveChatPollDetails.PollMetadata
	2,  // 20: youtube.api.v3.LiveChatPollDetails.status:type_name -> youtube.api.v3.LiveChatPollDetails.PollStatusWrapper.PollStatus
	28, // 21: youtube.api.v3.LiveChatGiftDetails.gift_duration:type_name -> google.protobuf.Duration
	21, // 22: youtube.api.v3.SuperChatEventSnippet.supporter_details:type_name -> youtube.api.v3.ChannelProfileDetails
	20, // 23: youtube.api.v3.SuperChatEventSnippet.super_sticker_metadata:type_name -> youtube.api.v3.SuperStickerMetadata
	27, // 24: youtube.api.v3.LiveChatPollDetails.PollMetadata.options:type_name -> youtube.api.v3.LiveChatPollDetails.PollMetadata.PollOption
